...
def execute_script():
    ...
    for log_file_path in paths.keys():
        ...
        f.write("INSERT_INTO:" + str(data[log_file_path]["INSERT_INTO"]) + '\n')
        f.write("==============================================================================\n")
        f.write("UPDATE:" + str(data[log_file_path]["UPDATE"]) + '\n')
        f.write("==============================================================================\n")
        f.write("DELETE_FROM: " + str(data[log_file_path]["DELETE_FROM"]) + '\n')
        f.write("==============================================================================\n")
        f.write("SELECT:" + str(data[log_file_path]["SELECT"]) + '\n')
        f.write("******************************************************************************\n")
        f.write("******************************************************************************\n")
        f.close()
